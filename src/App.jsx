...
function reducer(state, { type, payload }) {
  switch (type) {
    ...
    case ACTIONS.DELETE_DIGIT:
      // czyści wynik po wykonaniu operacji
      if (state.overwrite) {
        return {
          ...state,
          currentOperand: null,
...
//   previousOperand: "3",
//   operation: "+",
// overwrite: true/false - dodatkowa zmienna w stanie w funkcji evaluate , czy "=" zostało wciśnięte i trzeba wyzerować
// }
